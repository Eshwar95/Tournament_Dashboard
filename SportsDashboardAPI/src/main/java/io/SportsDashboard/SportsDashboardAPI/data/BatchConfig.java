...
public class BatchConfig {
    ...
    //itemprocessor of Spring batch
    @Bean
    public matchDataProcessor processor() {

        return new matchDataProcessor();
    }
    //itemwriter of Spring batch
    @Bean
    ...
    //we have one step that does the reading, processing and writing parts of the spring batch job
    @Bean
